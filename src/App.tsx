  ...
  return (
    <Router>
      <div className="min-h-screen bg-gray-100">
        ...
        <main className="p-6">
          <Routes>
            <Route path="/" element={<h2 className="text-2xl font-semibold">Onglet de Sujets</h2>}/>
            <Route path="/periodes" element={<h2 className="text-2xl font-semibold">Onglet de Périodes</h2>}/>
            <Route path="/formations" element={<h2 className="text-2xl font-semibold">Onglet de Formations</h2>}/>
          </Routes>
        </main>
      </div>
    </Router>
